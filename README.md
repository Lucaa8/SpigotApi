...
## Download
Get the latest version of SpigotApi [here](https://mvn.luca-dc.ch/repository/dev-mc/ch/luca008/SpigotApi/2.2/SpigotApi-2.2.jar) and put it inside your plugins folder. \
**Current version of SpigotApi:** 2.2
